...
```bash
HQ_SELFTEST=1 npm start        # prueba de humo (~60s, 194 comprobaciones)
HQ_SELFTEST=2 npm start        # + verificaciones contra el reloj real (~4min, 205)
node tools/prueba-repaso.js    # algoritmo de repaso espaciado (30)
node tools/prueba-notas.js     # formato de las notas y las fórmulas (164)
node tools/prueba-datos.js     # resistencia del archivo de datos (93)
